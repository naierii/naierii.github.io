import { pauseAllMedia, debounce } from './utils';
        ...
        class MediaGallery extends HTMLElement {
            ...
            announceLiveRegion(activeItem, position) {
                ...
                image.onload = () => {
                    ...
                    setTimeout(() => {
                        this.elements.liveRegion.setAttribute(
                            'aria-hidden',
                            true
                        );
                    }, 2000);
            ...
            preventStickyHeader() {
                ...
                this.stickyHeader.dispatchEvent(
                    new Event('preventHeaderReveal')
                );
            }

            removeListSemantic() {
                if (!this.elements.viewer.slider) return;
                this.elements.viewer.slider.setAttribute(
                    'role',
                    'presentation'
                );
