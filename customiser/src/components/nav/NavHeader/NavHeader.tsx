...
function sampleAlert() {
  alert(
    'Lorem ipsum dolor sit amet. Ab mollitia nihil qui perspiciatis labore nam mollitia delectus et debitis reprehenderit quo voluptatem autem',
  );
}
  ...
  return (
    <div className={rootClassName} onClick={onClick}>
      <div className={styles.nav}>
        ...
        <div className={styles.infoIcon} onClick={sampleAlert}>
          i
        </div>
      </div>
    </div>
